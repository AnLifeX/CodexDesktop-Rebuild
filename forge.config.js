...
module.exports = {
  ...
  makers: [
    ...
    { name: "@electron-forge/maker-zip", platforms: ["win32"] },
    {
      ...
      config: { options: { name: "codex", productName: "Codex", genericName: "AI Coding Assistant", categories: ["Development", "Utility"], bin: "Codex", maintainer: "Cometix Space", homepage: "https://github.com/anlifex/CodexDesktop-Rebuild", icon: "./resources/electron.png" } },
    },
    {
      name: "@electron-forge/maker-rpm",
      config: { options: { name: "codex", productName: "Codex", genericName: "AI Coding Assistant", categories: ["Development", "Utility"], bin: "Codex", license: "Apache-2.0", homepage: "https://github.com/anlifex/CodexDesktop-Rebuild", icon: "./resources/electron.png" } },
    },
